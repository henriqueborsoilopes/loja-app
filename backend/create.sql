...
create table endereco (id int4 generated by default as identity, bairro varchar(255), cep varchar(255), complemento varchar(255), lograduro varchar(255), numero varchar(255), cidade_id int4, cliente_id int4, primary key (id));
...
create table produto_categoria (produto_id int4 not null, categoria_is int4 not null);
...
alter table if exists produto_categoria add constraint FKa39uweuq8sr1w19ejdg354m3q foreign key (categoria_is) references categoria;
